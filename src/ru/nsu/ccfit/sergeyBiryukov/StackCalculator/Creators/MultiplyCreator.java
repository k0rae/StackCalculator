...
import ru.nsu.ccfit.sergeyBiryukov.StackCalculator.Instructions.MultiplyInstruction;
import ru.nsu.ccfit.sergeyBiryukov.StackCalculator.Program;

import java.util.List;

public class MultiplyCreator implements InstructionCreator {
    @Override
    public Instruction create(Program program, List<String> args) {
        return new MultiplyInstruction(program, args);
    }
}
